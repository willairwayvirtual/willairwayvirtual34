...
Partial Class book_a_flght
    ...
    Try
        ...
        Dim cmd1 As New OleDbCommand(
            "INSERT INTO Bookaflght (FltNum, Deptair, Arrair, deptime, Uname, Dte) 
             VALUES (@a1, @a2, @a3, @a4, @a5, @a6)", cn)
        ...
        Dim cmd2 As New OleDbCommand(
            "INSERT INTO Repfltdeck (FltNum, Deptair, Arrair, deptime, Uname, Dte) 
             VALUES (@b1, @b2, @b3, @b4, @b5, @b6)", cn)
