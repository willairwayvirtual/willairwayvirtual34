...
<body>
    <form id="form1" runat="server">
        ...
        <p class="auto-style13">
            ...
            <asp:Button ID="Button4" runat="server" CssClass="auto-style6" Text="Need an account?" Width="327px" BorderColor="White" BackColor="#999999" Height="49px" />
        </p>
        ...
        <p class="auto-style11">
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button5" runat="server" BackColor="#FF9900" BorderColor="#999999" CssClass="auto-style14" Text="Reset your password" Width="698px" />
        </p>
        <p class="auto-style12">
            &nbsp;</p>
    <p class="auto-style1">
